...
public class AddGoogleWActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_google_w2);
    ...
    public void AddMethod(String cardnumber, String cvvCode) {
        ...
        collectionReference.document(id).set(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AddGoogleWActivity2.this, "Error :" + e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
